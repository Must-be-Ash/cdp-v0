...
export function WishlistItem({ item, recipientAddress }: WishlistItemProps) {
  return (
    <div className="flex items-center gap-4 p-4 bg-white/90 backdrop-blur-2xl border border-amber-200 rounded-3xl mb-3 shadow-lg">
      <div className="w-16 h-16 bg-amber-50 backdrop-blur-sm rounded-2xl border border-amber-200 flex items-center justify-center overflow-hidden">
        <Image
